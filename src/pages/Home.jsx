...
const cardsData = [
  { id: 1, title: "تحاليل طبية", img: "/images/تحاليل.png", link: "/MedicalTests", icon: FaFlask },
  { id: 2, title: "نصائح طبية", img: "/images/نصائح طبية.webp", link: "/MedicalAdvice", icon: FaStethoscope },
  { id: 3, title: "تذكير الأدوية", img: "/images/ادوية.png", link: "/MedicationReminder", icon: FaPills },
  { id: 4, title: "الجيم", img: "/images/الجيم.jpg", link: "/Gym", icon: FaDumbbell },
  { id: 5, title: "الطوارئ الذكية", img: "/images/الطوارئ.png", link: "/SmartEmergencyRoom", icon: FaAmbulance },
  { id: 6, title: "إدارة الصحة", img: "/images/إدارة.webp", link: "/HealthAdministration", icon: FaClipboardList }
];
